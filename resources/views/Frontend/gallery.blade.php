    ...
    $categories = $images->pluck('category')->unique()->filter()->values();
                ...
                <div class="gallery-grid row g-3" id="galleryGrid">
                    ...
                    @forelse($images as $image)
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 gallery-item"
                             data-category="{{ Str::lower($image->category) }}">
                            <div class="gallery-card">
                                <img src="{{ asset('storage/' . $image->image) }}"
                                     alt="{{ $image->title }}" class="gallery-card__img">
        ...
        <script>
            ...
            function buildGalleryData() {
                document.querySelectorAll('.gallery-item:not(.d-none)').forEach(el => {
            ...
            function getVisibleItems() {
                return [...document.querySelectorAll('.gallery-item:not(.hidden):not(.d-none)')];
            }
