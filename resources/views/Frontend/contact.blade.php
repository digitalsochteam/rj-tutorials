...
@section('title', $seo->meta_title ?: 'Contact Us')

@push('meta')
    <meta name="description"
        content="{{ $seo->meta_description ?: 'Get in touch with RJ Tutorials. Located in Chembur, Mumbai. Enquire about coaching for JEE, NEET, MHCET & board exams.' }}">
