...
@section('content')
    ...
    <div style="margin-bottom:1.75rem;display:flex;align-items:center;justify-content:space-between;">
        <div>
            <h2 style="font-size:1.3rem;font-weight:800;letter-spacing:-0.025em;">Add Testimonial</h2>
            <p style="font-size:0.875rem;color:#64748b;margin-top:0.2rem;">Add a new student or client review.</p>
        </div>
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name') }}"
                            placeholder="e.g. Abhishek Atkari" required>
                    </div>
                    <div class="form-group">
                        <label for="designation">Designation / Label</label>
                        <input type="text" id="designation" name="designation"
                            value="{{ old('designation', 'Our Students') }}" placeholder="e.g. Our Students">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group full">
                        <label for="photo">Photo <small style="color:#94a3b8;">(optional)</small></label>
            ...
            <div class="form-body">
                <div class="form-group full">
                    ...
                    <textarea id="message" name="message" rows="5"
                        placeholder="Write the testimonial message here...">{{ old('message') }}</textarea>
                </div>
            </div>
        </div>
