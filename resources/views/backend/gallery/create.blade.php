...
@section('content')
    ...
    <form method="POST" action="{{ route('gallery.store') }}" enctype="multipart/form-data" id="gallery-form">
            ...
            <div class="form-body" style="padding:.75rem 1.25rem;">
                <div style="display:flex;align-items:center;gap:.6rem;flex-wrap:wrap;">
                    ...
                    <div id="video-source-toggle"
                        style="display:none;margin-left:.5rem;border-left:2px solid #e2e8f0;padding-left:.75rem;">
        ...
        <div class="form-card">
            <div class="form-card-header">
                ...
                <div class="form-card-sub">Title, category and sort order.</div>
            </div>
            <div class="form-body">
                <div class="form-grid">
            ...
            <div class="form-body">
                <div class="form-group">
                    ...
                    <div id="multi-preview-wrap"
                        style="margin-top:.75rem;display:flex;flex-wrap:wrap;gap:.75rem;"></div>
                </div>
            </div>
        </div>
        ...
        <div class="form-card" id="section-video-file" style="display:none;">
            <div class="form-card-header">
                ...
                <div class="form-card-sub">MP4, WebM, MOV. Max 100 MB.</div>
            </div>
            <div class="form-body">
                <div class="form-group">
    ...
    <script>
        ...
        function setMediaType(type, vSrc) {
            ...
            document.getElementById('video-source-toggle').style.display = isVideo ? 'flex' : 'none';
        ...
        function setVideoSource(src) {
            ...
            setMediaType(document.getElementById('media_type_input').value, src);
        }
            ...
            Array.from(input.files).forEach(file => {
                ...
                reader.onload = e => {
                    ...
                    box.innerHTML = `<img src="${e.target.result}"
                        style="width:120px;height:90px;object-fit:cover;border-radius:8px;border:2px solid #e2e8f0;">
