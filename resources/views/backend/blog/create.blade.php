    ...
    <form method="POST" action="{{ route('blog.store') }}" enctype="multipart/form-data">
        ...
        <div class="form-card">
            ...
            <div class="form-body">
                <div class="form-grid">
                    <div class="form-group full">
                        <label>Meta Title <small style="color:#94a3b8;">(leave blank to use post title &mdash; 50-60
                                chars)</small></label>
                    ...
                    <div class="form-group full">
                        <label>Meta Description <small style="color:#94a3b8;">(leave blank to use excerpt &mdash; 150-160
                                chars)</small></label>
